...
CC          = gcc
OPENMP     ?= -fopenmp
CFLAGS      = -O2 -Wall -Wextra -I include -I src -I host -I test/pytorch -I model/fp32 -I model/quant -I train -I configs/lenet/pins -I configs/vgg7/pins -I configs/resnet18/pins $(OPENMP) $(CFLAGS_EXTRA)
LDFLAGS     = -lm
...
SRCS_MODEL_QUANT  = model/quant/quant_lenet.c model/quant/quant_lenet_pinned.c configs/lenet/pins/table.c
...
SRCS_TRAIN_QUANT = train/train_common.c train/train_eval.c train/model_io_quant.c train/binio.c train/train_options.c train/scale_stats.c train/dump_state.c train/dump_raw.c train/train_quant.c train/train_quant_args.c train/train_quant_eval.c train/train_quant_setup.c train/train_quant_step.c
...
SRCS_TRAIN_QUANT_R18 = train/train_quant_resnet18.c train/train_quant_resnet18_args.c \
                       ...
                       train/train_quant_resnet18_eval.c \
...
SRCS_TRAIN_QUANT_VGG7 = train/train_common_vgg7.c train/train_eval.c \
                        ...
                        train/model_io_quant_vgg7.c train/binio.c train/scale_stats.c train/train_quant_vgg7_args.c \
...
clean-vgg7:
	rm -f host/cifar_loader.o model/fp32/fp32_vgg7.o \
	      ...
	      train/model_io_quant_vgg7.o train/train_quant_vgg7_args.o \
